...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["Zbychu"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	Scripts.IPHunter = false;
		Config.IPHunter.IPList = [75]; // List of IPs to look for. example: [165, 201, 64]
		Config.IPHunter.GameLength = 0; // Number of minutes to stay in game if ip wasn't found
