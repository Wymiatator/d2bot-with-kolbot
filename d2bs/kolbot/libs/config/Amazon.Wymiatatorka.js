...
function LoadConfig() {
	...
	*/
	...
	Config.QuitListDelay = [1, 3]; // Quit the game with random delay in case of using Config.QuitList. Example: Config.QuitListDelay = [1, 10]; will exit with random delay between 1 and 10 seconds.
	...
	Scripts.BaalAssistant = true; // Used to leech or help in baal runs.
		...
		Config.BaalAssistant.KillEldritch = true;
	...
	Config.LightningFuryDelay = 0.3; // Lightning fury interval in seconds. LF is treated as timed skill.
